...
//    System.arraycopy(sourceFiles, 0, command, baseCommand.length, sourceCount);
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                 ...
                 * dotJavaLineIndex) { codeIndex = i; //System.out.println("i'm
                 * thinkin file " + i); codeLine = dotJavaLineIndex -
                 * code.getPreprocOffset(); } } } } //System.out.println("code
                 * line now " + codeLine); exception = new
                 * RunnerException(errorMessage, codeIndex, codeLine, -1,
                 * false);
                 */
                 ...
                 * errorMessage.substring(1) + ". You might be missing a
                 * library."); } else { exception = new
                 * RunnerException(errorMessage); }
                 */
